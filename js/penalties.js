...
import { DEFAULT_PENALTIES as PGTC_DEFAULT_PENALTIES } from "../data/pgtc/penalties.js?v=4.0.0";
import { DEFAULT_PENALTIES as ATM_DEFAULT_PENALTIES } from "../data/atm/penalties.js?v=4.0.0";
import { DEFAULT_PENALTIES as WHC_DEFAULT_PENALTIES } from "../data/whc/penalties.js?v=4.0.0";
import { DEFAULT_PENALTIES as MTC_DEFAULT_PENALTIES } from "../data/mtc/penalties.js?v=4.0.0";
import { DEFAULT_PENALTIES as GT3DL_DEFAULT_PENALTIES } from "../data/gt3dl/penalties.js?v=4.0.0";
import { DEFAULT_PENALTIES as MOM_DEFAULT_PENALTIES } from "../data/mom/penalties.js?v=4.0.0";
import { DEFAULT_PENALTIES as TWINGO_RUSH_DEFAULT_PENALTIES } from "../data/twingo-rush/penalties.js?v=4.0.0";
