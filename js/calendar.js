...
import { CALENDAR_CONFIG as PGTC_CALENDAR } from "../data/pgtc/calendar.js?v=4.0.0";
import { CALENDAR_CONFIG as ATM_CALENDAR } from "../data/atm/calendar.js?v=4.0.0";
import { CALENDAR_CONFIG as WHC_CALENDAR } from "../data/whc/calendar.js?v=4.0.0";
import { CALENDAR_CONFIG as MTC_CALENDAR } from "../data/mtc/calendar.js?v=4.0.0";
import { CALENDAR_CONFIG as GT3DL_CALENDAR } from "../data/gt3dl/calendar.js?v=4.0.0";
import { CALENDAR_CONFIG as MOM_CALENDAR } from "../data/mom/calendar.js?v=4.0.0";
import { CALENDAR_CONFIG as TWINGO_RUSH_CALENDAR } from "../data/twingo-rush/calendar.js?v=4.0.0";
import { getLeague } from "./leagues.js?v=4.0.0";
...
function updateHero(league, calendar, entries) {
  ...
  if (logo && fallback) {
    ...
    logo.src = `${league.logoPath}?v=4.0.0`;
  }

  if (watermark) {
    watermark.src = `${league.logoPath}?v=4.0.0`;
    watermark.alt = "";
  }
}
