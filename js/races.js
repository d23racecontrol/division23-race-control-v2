...
import { DEFAULT_RACES as PGTC_DEFAULT_RACES } from "../data/pgtc/races.js?v=3.5.0";
import { DEFAULT_RACES as ATM_DEFAULT_RACES } from "../data/atm/races.js?v=3.5.0";
import { DEFAULT_RACES as WHC_DEFAULT_RACES } from "../data/whc/races.js?v=3.5.0";
import { DEFAULT_RACES as MTC_DEFAULT_RACES } from "../data/mtc/races.js?v=3.5.0";
import { DEFAULT_RACES as GT3DL_DEFAULT_RACES } from "../data/gt3dl/races.js?v=3.5.0";
import { DEFAULT_RACES as MOM_DEFAULT_RACES } from "../data/mom/races.js?v=3.5.0";
import { DEFAULT_RACES as TWINGO_RUSH_DEFAULT_RACES } from "../data/twingo-rush/races.js?v=3.5.0";
